...
#define		KASA_Encoder4_2  2800	//坂上終わり(最後の坂道)2500 3000
...
int		    C_TOPSPEED3	=		42;		//再生走行用クランク(入)  25 33 
int 		C_TOPSPEED5 = 		42;		//再生走行時のブレーキ前 距離短い時用
